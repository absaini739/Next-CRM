                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-gray-50 border-b">
                                <tr>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-slate-500 uppercase">Field Name</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-slate-500 uppercase">Entity</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-slate-500 uppercase">Type</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-slate-500 uppercase">Required</th>
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {customFields.map(field => (
                                    <tr key={field.id} className="hover:bg-gray-50">
                                        <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-slate-100">{field.name}</td>
                                        <td className="px-6 py-4 text-sm text-gray-500 dark:text-slate-500">{field.entity}</td>
                                        <td className="px-6 py-4 text-sm text-gray-500 dark:text-slate-500">{field.type}</td>
