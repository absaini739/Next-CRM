...
function EmailsContent() {
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            await api.post('/emails/bulk/delete', {
                ids: selectedEmails
            });
            toast.success(`${selectedEmails.length} emails moved to trash`);
            setSelectedEmails([]);
            fetchEmails();
            fetchCounts();
        } catch (error) {
    ...
    const handleBulkMarkRead = async (isRead: boolean) => {
        ...
        try {
            ...
            toast.success(`${selectedEmails.length} emails marked as ${isRead ? 'read' : 'unread'}`);
            setSelectedEmails([]);
            fetchEmails();
        } catch (error) {
                            ...
                            <Card className="p-4">
                                <div className="flex flex-col space-y-4">
                                    ...
                                    {selectedEmails.length > 0 && (
                                        <div className="flex items-center justify-between px-3 py-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/50 rounded-lg animate-in fade-in slide-in-from-top-1">
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <div className="flex items-center space-x-1">
                                                    <Button
                                                        ...
                                                        className="text-blue-700 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-800/40"
                                                    >
                                                        Mark as Read
                                                    </Button>
                                                    <Button
                                                    ...
                                                    <Button
                                                        ...
                                                        className="text-red-700 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/40"
                                                    >
                                            ...
                                            <tr>
                                                <th className="px-4 py-3 text-left w-12">
                                                    <input
                                                        ...
                                                        className="rounded border-gray-300 dark:border-gray-600 dark:bg-slate-700 h-4 w-4 text-blue-600 focus:ring-blue-500"
                                                    />
                                                </th>
